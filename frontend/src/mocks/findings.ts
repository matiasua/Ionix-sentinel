// Portado de frontend/design/mock-findings.js — mismo esquema Finding.
// Sirve como fixture mientras el backend no expone POST /api/scan (ver docs/07-backend-spec.docs.md §5).
...
export const snippetStart: Record<string, number> = {
  fnd_001: 9,
  fnd_002: 44,
  fnd_003: 4209,
  fnd_004: 87,
